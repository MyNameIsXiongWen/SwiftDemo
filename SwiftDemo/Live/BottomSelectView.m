...
- (UIButton *)setWithCancleButton {
    UIButton *button = [[UIButton alloc]initWithFrame:CGRectMake(0, self.bounds.size.height - 44, UIScreen.mainScreen.bounds.size.width, 44)];
...
- (void)initWithConfignTableView {
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 44, UIScreen.mainScreen.bounds.size.width, self.bounds.size.height - 44- 10 -44) style:UITableViewStylePlain];
